...
public class StandardLunisolarTest {
  ...
  public void test() {
    ...
    final StandardLunisolar lunisolarS = new StandardLunisolar(365.242234, 29.530588, ZoneOffset.ofHours(9));
    // @formatter:off
    assertThat(
    LongStream.rangeClosed(1844, 2300)
    .mapToObj(y->new LunisolarCalendar(lunisolarS, Julian.ofEpochMilli(t.with(ChronoField.YEAR, y).toInstant().toEpochMilli())))
